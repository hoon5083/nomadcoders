...
const Community: NextPage = () => {
	return (
		<div className="px-4 py-16 space-y-8">
			{[1, 2, 3, 4, 5, 6].map((_, i) => (
				<div key={i} className="flex flex-col items-start cursor-pointer">
					...
					<div className="mt-2 text-gray-700">
						<span className="font-medium text-indigo-500">Q.</span> What is the
			...
			<button className="fixed p-4 text-white bg-indigo-400 rounded-full shadow-xl cursor-pointer transitons-color hover:bg-indigo-500 bottom-24 right-5">
				<svg
					className="w-6 h-6"
					fill="none"
					stroke="currentColor"
